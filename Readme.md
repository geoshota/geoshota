...
　先に挙げた[分野](#分野)の中でも，地理学の中で特別な関心を払ってきた行動地理学や社会地理学的な視点による定性的な情報と,Kwan(2004)に代表されるような人流データや統計，地理的な位置が付与された情報などを活用した定量的なデータの地理情報科学を活用した視覚化の両面から，以上述べた研究に取り組む必要があり，具体的には，
>卒業論文での結果を基に統計&社会科学系データによる検討を加え，議論に上積みする形で，
